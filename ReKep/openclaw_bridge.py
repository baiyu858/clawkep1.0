...
def build_real_worker_argv(args):
    ...
    if args.rekep_execution_mode:
        worker_argv.extend(["--rekep_execution_mode", args.rekep_execution_mode])
...
def main():
    ...
    parser.add_argument("--rekep_execution_mode", type=str, choices=["solver", "vlm_stage"], default=None)
