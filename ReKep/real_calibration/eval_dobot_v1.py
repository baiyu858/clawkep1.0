...
def main(cfg: DictConfig):
    ...
    _robot_l, _robot_r, thread_dobot = init_robots(
        robot_ip_left=os.environ.get("DOBOT_LEFT_IP", "127.0.0.1"),
        robot_ip_right=os.environ.get("DOBOT_RIGHT_IP", "127.0.0.1"),
        port=6001,
        hostname="127.0.0.1"
    )
